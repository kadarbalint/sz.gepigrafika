...
void read_element_from_line(const char* line, Model* model)
{
	...
	if (token_array.n_tokens > 0) {
		...
		if (strcmp(first_token, "v") == 0) {
            ...
            printf("Unknown token! %s", first_token);
        }
	}
